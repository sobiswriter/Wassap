...
export const SettingsPopover: React.FC<SettingsPopoverProps> = ({ settings, onUpdate, onClose }) => {
  return (
    <div className="absolute left-[80px] bottom-20 w-[300px] app-panel rounded-lg shadow-2xl border app-border z-[1000] animate-in slide-in-from-bottom-2 duration-200 overflow-hidden">
      <div className="p-4 border-b app-border flex justify-between items-center app-header">
        <h3 className="font-medium text-primary text-[16px]">Settings</h3>
      ...
      <div className="p-4 space-y-5">
        <div className="flex items-center justify-between">
          <div className="flex items-center gap-3">
            ...
            <div>
              <p className="text-[14.5px] text-primary font-medium">App Theme</p>
        ...
        <div className="flex items-center justify-between">
          <div className="flex items-center gap-3">
            ...
            <div>
              <p className="text-[14.5px] text-primary font-medium">Share AI Context</p>
