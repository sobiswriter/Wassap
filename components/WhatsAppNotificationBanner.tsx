...
export const WhatsAppNotificationBanner: React.FC<WhatsAppNotificationBannerProps> = ({
  ...
  return (
    <div
      className={`fixed top-3 left-1/2 -translate-x-1/2 z-[9999] w-[calc(100%-1.5rem)] max-w-[420px] transition-all duration-300 ease-out cursor-pointer select-none ${
        isVisible
    ...
    >
      <div className="relative group">
        ...
        {/* Main Banner Card */}
        <div
          className={`relative z-10 rounded-[26px] p-3.5 pl-3.5 pr-4 flex items-center gap-3.5 shadow-2xl backdrop-blur-xl transition-all duration-300 active:scale-[0.98] ${
            isDark
        ...
        >
          {/* Avatar Container with WhatsApp Green Badge */}
          <div className="relative shrink-0 w-11 h-11">
            <img
              ...
              className="w-11 h-11 rounded-full object-cover bg-neutral-300 dark:bg-neutral-700 shadow-sm"
              onError={(e) => {
                // Fallback image
            ...
            <div className="absolute -bottom-0.5 -right-0.5 w-[20px] h-[20px] rounded-[6px] bg-[#25D366] flex items-center justify-center shadow-md ring-2 ring-[#f6f6f8] dark:ring-[#2c2c2e]">
              <svg className="w-3 h-3 fill-white" viewBox="0 0 100 100">
          ...
          <div className="flex-1 min-w-0">
            ...
            <p className={`text-[14px] leading-snug line-clamp-2 ${isDark ? 'text-[#e5e5ea]' : 'text-[#3a3a3c]'}`}>
