...
export const DEFAULT_GCP_PROJECT = 'gen-lang-client-0100408368';
export const DEFAULT_GCP_REGION = 'global';
 ...
 * 2. Individual GCP credentials (GCP_CLIENT_EMAIL, GCP_PRIVATE_KEY, and their aliases)
...
export const getVertexClient = () => {
  ...
  // If running locally with ADC or GOOGLE_APPLICATION_CREDENTIALS file path
  ...
  // Fallback: If deployed to Vercel and user configured GEMINI_API_KEY as the built-in server credit key
